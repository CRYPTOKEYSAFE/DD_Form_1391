...
1. Single-line entry by CCN. Concur. Bldg 1024 is one CCN, so the proposed Block 9 collapses the eleven UNIFORMAT-prefixed scope rows into one Primary Facility line keyed to the building CCN. Same approach across SCH-3270, SCH-3213, SCH-3237, and SCH-3314, all single-CCN buildings.

2. Area times unit cost on one line. Concur. Bldg 1024 reads as area (26,488 SF, first-floor renovation), user-derived unit cost, amount. No discipline or trade breakdown on the items table.
...
5. Contingency, SIOH, and design fee. Concur on the percent rollup mechanism through the Associated Costs dialog. One open item before I lock: our local cost chain carries the design fee (6% for DBB or 4% for DB per acquisition method) and a separate 4% Construction Management adder. Need to confirm CM's local authority before deciding whether it rides with the design fee in Planning and Design or stands alone. Bldg 1024 is Design-Build, so the design fee piece is 4% for that one.

6. NAVFAC 11010.44 status. Mea culpa. I crossed my NAVFAC and MCO citations on this one. Between the two stacks there are something like ninety reference documents and I grabbed the wrong shelf. MCO 11000.12 is solid; the 11010.44 leg is where I got it wrong. I will pull the current NAVFAC authority for the 2.5%-of-PRV LSH allowance and come back with the right citation.

Net. Items 1, 2, and 4 are resolved. Item 5 closes once I confirm the CM authority and acquisition method per building. Items 3 and 6 are linked, and I will come back with the LSH path and the right reference. Open to a walk-through on Bldg 1024 whenever works for you.
